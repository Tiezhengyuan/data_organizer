...
public class VehiclesOfInterestController {
    ...
    */
    ...
    /*
    Description:  This method returns all of the reasons for interest from the database 
    and create a 2D array in the following format [row][col].  The first column 
    is the reason and the second column is the description.
    */      
    public String[][] getAllReasonsForInterest()
    {
        ...
        // return array         
        //System.out.println(Arrays.deepToString(allReasonOfInteresttArr));
    ...
    */  
    ...
    /*
            ...
            key values of the reason for interest.
     */
    {
